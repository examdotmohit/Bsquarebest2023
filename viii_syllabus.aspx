<%@ Page Title="" Language="C#" MasterPageFile="/main.master" AutoEventWireup="true" CodeFile="viii_syllabus.aspx.cs" Inherits="v_syllabus" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>VIII Class Syllabus | <%= maincontent.websitename %></title>
</asp:Content>
        ...
        <div class="container">
            <div class="row sylabus-row">
                <div class="row Heading">
                    ...
                    <h1 style="color: rgb(63, 87, 140);">Exam Syllabus For Class VIII</h1>
                    <p class="parag">
                                ...
                                <div id="pills-tabContent" class="tab-content">
                                    ...
                                    <div id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab"
                                        ...
                                        <div class="pattern">
                                            ...
                                            <li>Materials: Metals &amp; Non-Metals</li>
                                    ...
                                    <div id="pills-profile2" role="tabpanel" aria-labelledby="pills-profile-tab"
                                        ...
                                        <div class="pattern">
                                            ...
                                            <li>Crop Production &amp; Management</li>
                                    ...
                                    <div id="pills-profile4" role="tabpanel" aria-labelledby="pills-profile-tab"
                                        ...
                                        <div class="pattern">
                                            ...
                                            <li>Ranking Test</li>
                                            <li>Calendar</li>
                                            <li>Analogy &amp; Similarity &amp; Word Formation</li>
                                        </div>
                                    </div>
                                </div>
                            </div>
