<%@ Page Title="" Language="C#" MasterPageFile="/main.master" AutoEventWireup="true" CodeFile="vi_syllabus.aspx.cs" Inherits="v_syllabus" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>VI Class Syllabus | <%= maincontent.websitename %></title>
</asp:Content>
        ...
        <div class="container">
            <div class="row sylabus-row">
                <div class="row Heading">
                    ...
                    <h1 style="color: rgb(63, 87, 140);">Exam Syllabus For Class VI</h1>
                    <p class="parag">
                                ...
                                <div id="pills-tabContent" class="tab-content">
                                    <div id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab"
                                        ...
                                        <div class="pattern">
                                            ...
                                            <li>Motion &amp; Measurement of Distances</li>
                                            <li>Light, Shadow &amp;Reflection</li>
                                    ...
                                    <div id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab"
                                        ...
                                        <div class="pattern">
                                            ...
                                            <li>Sorting Material into groups </li>
                                    ...
                                    <div id="pills-profile2" role="tabpanel" aria-labelledby="pills-profile-tab"
                                        ...
                                        <div class="pattern">
                                            ...
                                            <li>Food: Where Does It Come From?</li>
                                            <li>Components Of Food</li>
                                            <li>Getting To Know Your Plants</li>
                                        </div>
                                    </div>
