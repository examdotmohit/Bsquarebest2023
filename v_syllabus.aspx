<%@ Page Title="" Language="C#" MasterPageFile="/main.master" AutoEventWireup="true" CodeFile="v_syllabus.aspx.cs" Inherits="v_syllabus" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Vth Syllabus | <%= maincontent.websitename %></title>
</asp:Content>
        ...
        <div class="container">
            <div class="row sylabus-row">
                <div class="row Heading">
                    ...
                    <h1 style="color: rgb(63, 87, 140);">Exam Syllabus For Class V</h1>
                    <p class="parag">
                        Syllabus consists of topics from Current Class and Previous Class. Students are advised
                    to find these topics from their school text books of present and previous years and prepare
                    thoroughly for MCQs.
                    </p>
                </div>
                                ...
                                <div id="pills-tabContent" class="tab-content">
                                    ...
                                    <div id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab"
                                        ...
                                        <div class="pattern">
                                            ...
                                            <li>Air, Water &amp; Weather</li>
                                            <li>Matter &amp; Material</li>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-12 card-class-last">
                                <ul>
                                    <li><span><i aria-hidden="true" class="fa fa-file-text icon-mode"></i></span>
                                        <div class="icon-left">
                                            <p class="m-t">
                                                <strong>Exam Dates : </strong>27 Nov. &amp; 4
                                            Dec. 2022
                                            </p>
                                        </div>
                                    </li>
                                    ...
                                    <li><span><i aria-hidden="true" class="fa fa-pie-chart icon-mode"></i></span>
                                        <div class="icon-left">
                                            <p class="m-t">
                                                <strong>Marking Scheme : </strong>The Exam will be conducted on
                                            OMR (Optical Mark Reader) Sheet. +4 for correct answer (No negative marking
                                            for wrong answer)
                                            </p>
                                        </div>
                                    </li>
