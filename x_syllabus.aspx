<%@ Page Title="" Language="C#" MasterPageFile="/main.master" AutoEventWireup="true" CodeFile="x_syllabus.aspx.cs" Inherits="v_syllabus" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>X Class Syllabus | <%= maincontent.websitename %></title>
</asp:Content>
        ...
        <div class="container">
            <div class="row sylabus-row">
                <div class="row Heading">
                    ...
                    <h1 style="color: rgb(63, 87, 140);">Exam Syllabus For Class X</h1>
                    <p class="parag">
                                ...
                                <div id="pills-tabContent" class="tab-content">
                                    ...
                                    <div id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab"
                                        ...
                                        <div class="pattern">
                                            ...
                                            <li>Carbon &amp; its Compounds</li>
                                            <li>Chemical Reaction &amp; Equation</li>
                                    ...
                                    <div id="pills-profile2" role="tabpanel" aria-labelledby="pills-profile-tab"
                                        ...
                                        <div class="pattern">
                                            ...
                                            <li>How do Organism Reproduce</li>
                                            <li>Heredity </li>
                                        </div>
                                    </div>
                                    <div id="pills-profile3" role="tabpanel" aria-labelledby="pills-profile-tab"
                                        ...
                                        <div class="pattern">
                                            ...
                                            <li>Real Number </li>
                                            <li>Polynomial</li>
                                            <li>Pair of Linear Equations in two Variable</li>
                                    ...
                                    <div id="pills-profile4" role="tabpanel" aria-labelledby="pills-profile-tab"
                                        ...
                                        <div class="pattern">
                                            ...
                                            <li>Logical Sequence Of Word</li>
                                            <li>Ranking Test</li>
                                            <li>Seating Arrangement</li>
                                            <li>Puzzle</li>
                                            <li>Analogy And Similarity</li>
                                            <li>Calendar</li>
