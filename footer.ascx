<%@ Control Language="C#" AutoEventWireup="true" CodeFile="footer.ascx.cs" Inherits="header" %>
  <section class="footer">
    <footer class="text-center text-lg-start bg-purple text-muted">
...
<br /><br /><br />
                  ...
                  <ul class="ft-socialicons list-unstyled">
                    <li class="ft-soci ft-facebook">
                      <a href="" class="text-reset">
                        <i class="fa fa-facebook" aria-hidden="true"></i>
                      </a>
                    </li>
                    <li class="ft-soci ft-twitter">
                      <a href="" class="text-reset">
                        <i class="fa fa-twitter" aria-hidden="true"></i>
                      </a>
                    </li>
                    <li class="ft-soci ft-google">
                      <a href="" class="text-reset">
                        <i class="fa fa-google" aria-hidden="true"></i>
                      </a>
                    </li>
                    <li class="ft-soci ft-instagram">
                      <a href="" class="text-reset">
                        <i class="fa fa-instagram" aria-hidden="true"></i>
                      </a>
                    </li>
                    <li class="ft-soci ft-linkedin">
                      <a href="" class="text-reset">
                        <i class="fa fa-linkedin" aria-hidden="true"></i>
                      </a>
                    </li>
                    <li class="ft-soci ft-whatsapp">
                      <a href="" class="text-reset">
                        <i class="fa fa-whatsapp" aria-hidden="true"></i>
                      </a>
                    </li>
                    <li class="ft-soci ft-telegram">
                      <a href="" class="text-reset">
              ...
              <div class="col-md-3 col-lg-3 mx-auto mb-4 ">
                  ...
                  <ul class="list-unstyled ft-menulist">
                   
                    
                      <li class="pb-2" style="color: white;">
                        <a href="/" class="text-reset text-capitalize" style="color: white;text-decoration: none;"> <i class="fa fa-angle-double-right me-2" aria-hidden="true"></i>  home</a>
                      ...
                      <li class="pb-2" style="color: white;">
                        <a href="/exam-center" class="text-reset text-capitalize" style="color: white;text-decoration: none;"> <i class="fa fa-angle-double-right me-2" aria-hidden="true"></i>  Test Center</a>
              ...
              <div class="col-md-3 col-lg-3 mx-auto mb-4 ">
                ...
                <!-- <p style="color: white;">
                  <a href="/about" class="text-reset" style="color: white;text-decoration: none;"><i class="fa fa-angle-double-right" aria-hidden="true"></i>About Us</a>
                </p> -->
                <!-- <p style="color: white;">
                  <a href="#" class="text-reset" style="color: white;text-decoration: none;">Services</a>
                </p> -->
              </div>
