<%@ Page Title="" Language="C#" MasterPageFile="/main.master" AutoEventWireup="true" CodeFile="xii_math_syllabus.aspx.cs" Inherits="v_syllabus" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>XII (Math) Class Syllabus | <%= maincontent.websitename %></title>
</asp:Content>
        ...
        <div class="container">
            <div class="row sylabus-row">
                <div class="row Heading">
                    ...
                    <h1 style="color: rgb(63, 87, 140);">Exam Syllabus For Class XII (Math)</h1>
                    <p class="parag">
                                ...
                                <div id="pills-tabContent" class="tab-content">
                                    <div id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab"
                                        ...
                                        <div class="pattern">
                                            ...
                                            <li>Moving Charges &amp; Magnetism</li>
                                        </div>
                                    </div>
                                    <div id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab"
                                        ...
                                        <div class="pattern">
                                            ...
                                            <li>Solutions</li>
                                            <li>The p-block Elements (12th NCERT)</li>
                            ...
                            <div class="col-lg-12 card-class-last">
                                <ul>
                                    ...
                                    <li><span><i aria-hidden="true" class="fa fa-window-restore icon-mode"></i></span>
                                        <div class="icon-left">
                                            <p class="m-t"><strong>Subject Applicable : </strong>Physics (25) , Chemistry (25), Biology / Maths (25)</p>
                                        </div>
                                    </li>
                                    <li><span><i aria-hidden="true" class="fa fa-plus-circle icon-mode"></i></span>
                                        <div class="icon-left">
                                            <p class="m-t"><strong>Note : </strong>Biology Students must attempt Physics, Chemistry &amp; Biology Questions only &amp; Maths Students Can attempt Physics, Chemistry &amp; Maths Questions Only.</p>
                                        </div>
                                    </li>
                                    <li><span><i aria-hidden="true" class="fa fa-braille icon-mode"></i></span>
                                        <div class="icon-left">
                                            <p class="m-t"><strong>Total Question : </strong>75 Objective Type Questions | MCQs of 4 Choices (Single Correct Answer)</p>
                                        </div>
                                    </li>
                                    <li><span><i aria-hidden="true" class="fa fa-pie-chart icon-mode"></i></span>
                                        <div class="icon-left">
                                            <p class="m-t"><strong>Marking Scheme :  </strong>The Exam will be conducted on OMR (Optical Mark Reader) Sheet. +4 for each Correct Answer &amp; -1 for each incorrect Answer.</p>
                                        </div>
                                    </li>
