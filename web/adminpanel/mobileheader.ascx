<%@ Control Language="C#" AutoEventWireup="true" CodeFile="mobileheader.ascx.cs" Inherits="web_panel_mobileheader" %>
									...
									<div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
										...
										<%--<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
											<div class="menu-item me-lg-1">
												<a class="menu-link py-3" href="wallethistory.aspx">
													<span class="menu-title">Wallet Balance:  <b> <asp:Label ID="walletb" runat="server" Text="Label" ForeColor="Red"></asp:Label>
														</b> </span>
												</a>
											</div>

											<div class="menu-item me-lg-1">
												<a class="menu-link" href='<%= "https://wa.me/" + helpmob %>' target="_blank">
													<span class="menu-title">Helpline Number:&nbsp;  <b style="color:red"> <%= helpmob %> 
														</b> </span>
												</a>
											</div>
								...
								<div class="d-flex align-items-stretch flex-shrink-0">
									...
									<!--begin::Activities-->
										...
										<%--	<div class="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px" id="kt_activities_toggle">
											<a href="notification.aspx">	<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="blue" class="bi bi-bell" viewBox="0 0 16 16">
  <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zM8 1.918l-.797.161A4.002 4.002 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4.002 4.002 0 0 0-3.203-3.92L8 1.917zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5.002 5.002 0 0 1 13 6c0 .88.32 4.2 1.22 6z"/>
</svg><sup style="color:red"><b><asp:Literal ID="notinumber" runat="server"></asp:Literal></b></sup></a>
											</div>--%>
											<!--end::Drawer toggle-->
										</div>
										<!--end::Activities-->
										...
										<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
												...
												<div class="menu-item px-3">
													<div class="menu-content d-flex align-items-center px-3">
														...
														<div class="d-flex flex-column">
															<div class="fw-bolder d-flex align-items-center fs-5">Welcome, &nbsp;<asp:Label ID="username" runat="server" Text="Label"></asp:Label>
												...
												<%--<div class="menu-item px-5 my-1">
													<a href="changepwd.aspx" class="menu-link px-5">Change Password</a>
												</div>--%>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-5">
													<a href="logout.aspx" class="menu-link px-5">Log Out</a>
												</div>
												<!--end::Menu item-->
											</div>
											<!--end::Menu-->
