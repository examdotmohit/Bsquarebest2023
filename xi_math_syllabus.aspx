<%@ Page Title="" Language="C#" MasterPageFile="/main.master" AutoEventWireup="true" CodeFile="xi_math_syllabus.aspx.cs" Inherits="v_syllabus" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>XI (Math) Class Syllabus | <%= maincontent.websitename %></title>
</asp:Content>
        ...
        <div class="container">
            <div class="row sylabus-row">
                <div class="row Heading">
                    ...
                    <h1 style="color: rgb(63, 87, 140);">Exam Syllabus For Class XI (Math)</h1>
                    <p class="parag">
                            ...
                            <div class="col-lg-12 card-class-last">
                                <ul>
                                    ...
                                    <li><span><i aria-hidden="true" class="fa fa-pie-chart icon-mode"></i></span>
                                        <div class="icon-left">
                                            <p class="m-t"><strong>Marking Scheme :  </strong>The Exam will be conducted on OMR (Optical Mark Reader) Sheet. +4 for correct answer (No negative marking for wrong answer)</p>
                                        </div>
                                    </li>
