<%@ Page Title="" Language="C#" MasterPageFile="/main.master" AutoEventWireup="true" CodeFile="vii_syllabus.aspx.cs" Inherits="v_syllabus" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>VII Class Syllabus | <%= maincontent.websitename %></title>
</asp:Content>
        ...
        <div class="container">
            <div class="row sylabus-row">
                <div class="row Heading">
                    ...
                    <h1 style="color: rgb(63, 87, 140);">Exam Syllabus For Class VII</h1>
                    <p class="parag">
                                ...
                                <div id="pills-tabContent" class="tab-content">
                                    <div id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab"
                                        ...
                                        <div class="pattern">
                                            ...
                                            <li>Motion &amp; Time</li>
                                            <li>Electric Current &amp; its Effect</li>
                                            <li>Winds Storms &amp; Cyclones</li>
                                        </div>
                                    </div>
                                    ...
                                    <div id="pills-profile2" role="tabpanel" aria-labelledby="pills-profile-tab"
                                        ...
                                        <div class="pattern">
                                            ...
                                            <li>Weather, Climate and Adaptations of Animals to Climate</li>
                                        </div>
                                    </div>
