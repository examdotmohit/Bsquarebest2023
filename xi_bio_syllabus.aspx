<%@ Page Title="" Language="C#" MasterPageFile="/main.master" AutoEventWireup="true" CodeFile="xi_bio_syllabus.aspx.cs" Inherits="v_syllabus" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>XI (Bio) Class Syllabus | <%= maincontent.websitename %></title>
</asp:Content>
        ...
        <div class="container">
            <div class="row sylabus-row">
                <div class="row Heading">
                    ...
                    <h1 style="color: rgb(63, 87, 140);">Exam Syllabus For Class XI (Bio)</h1>
                    <p class="parag">
